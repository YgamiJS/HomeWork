  ...
  return (
    <>
      ...
      <div className={styled.content}>
        ...
        <Content props={{day: "monday" ,arrayLessons: [{ lessonInfo: {name: "История" ,  homeWork: "homeWork" }} , { lessonInfo: {name: "name" ,  homeWork: "homeWork" }} , { lessonInfo: {name: "name" ,  homeWork: "homeWork" }} ,{ lessonInfo: {name: "name" ,  homeWork: "homeWork" }} ,{ lessonInfo: {name: "name" ,  homeWork: "homeWork" }} ,{ lessonInfo: {name: "name" ,  homeWork: "homeWork" }} , { lessonInfo: {name: "name" ,  homeWork: "homeWork" }}]}} />
